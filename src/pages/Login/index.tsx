...
export default function Login() {
  ...
  useEffect(() => {
    if (data?.data) {
      const encoded = encodeURIComponent(data.data).replace(
        /%([0-9A-F]{2})/g,
  ...
  return (
    <LoginWrapper>
      <div className="cont_login">
        ...
        <div
          className={classNames("login_form", {
            show_login_form: isShowLogin,
            form_to_right: position === "right",
            form_to_left: position === "left",
          })}
        >
          <div>
